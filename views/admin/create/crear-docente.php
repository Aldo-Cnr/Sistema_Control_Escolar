  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-dark" id="exampleModalLabel">Agregar Docente</h5>
      ...
      <div class="modal-body  d-flex justify-content-center">
        ...
        <form method="POST" class="d-flex align-items-center justify-content-center flex-md-column">
            <div class="mb-2 w-100 position-relative">
              <input type="number" class="rounded-2 text-center" name="id_docente" placeholder="Matricula" autocomplete="off">
            </div>
            <div class="mb-2 w-100 position-relative">
            ...
            <div class="mb-2 w-100 position-relative">
              <input type="text" class="rounded-2 text-center" name="profesion" placeholder="profesion" autocomplete="off">
            </div>
...
<?php
 include('../../controllers/docentes/crear-docente-controller.php');
?>
