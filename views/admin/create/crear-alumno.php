  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title text-dark" id="exampleModalLabel">Agregar Alumno</h5>
      ...
      <div class="modal-body  d-flex justify-content-center">
        ...
        <form method="POST" class="d-flex align-items-center justify-content-center flex-md-column">
          <div class="mb-2 w-100 position-relative">
            <input type="number" class="rounded-2 text-center" name="id_alumno" placeholder="Matricula" autocomplete="off">
          </div>
          <div class="mb-2 w-100 position-relative">
          ...
          <div class="mb-2 w-100 position-relative">
            ...
            <select class="rounded-2 w-100 text-center" name="status" id="status">
              <option value="pagado">Pagado</option>
              <option value="adeudo">Adeudo</option>
            </select>
            <!-- <input type="text" class="rounded-2 text-center" name="status" placeholder="Status de pago" autocomplete="off"> -->
          </div>
...
<?php
 include('../../controllers/alumnos/crear-alumno-controller.php');
?>
