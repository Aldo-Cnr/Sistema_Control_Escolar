...
<body>
    <?php
        include('/xampp/htdocs/escuela/controllers/alumnos/editar-alumno-controller.php');
    ?>
    <!-- Modal Editar Alumno-->
    <div class="container d-flex align-items-center justify-content-center">
        <form method="POST" class="d-flex align-items-center justify-content-center flex-md-column">
            <h2 class="mb-2 mt-2">Editar Alumno</h2>
            <div class="mb-2 w-100 position-relative">
                <label class="text-white">Matricula:</label>
                <input type="number" class="form-control text-center" name="id_alumno" value="<?php echo $txtId; ?>" readonly>
            </div>
            <div class="mb-2 w-100 position-relative">
            ...
            <div class="mb-4 w-100 position-relative form-control">
                <label for="status" class="text-dark">Status de pago:</label>
                <select class="rounded-2 text-center w-100" name="status" value="<?php echo $status; ?>" id="status">
                    <option value="pagado">Pagado</option>
                    <option value="adeudo">Adeudo</option>
                </select>
            </div>
            <div>
                <a href="../crud-alumnos.php" class="btn btn-danger">Cancelar</a>
