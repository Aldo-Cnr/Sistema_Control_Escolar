...
<body>
    <?php
        include('/xampp/htdocs/escuela/controllers/admin/editar-admin-controller.php');
    ?>
    <!-- Modal Editar Administrador-->
    <div class="container d-flex align-items-center justify-content-center">
        <form method="POST" class="d-flex align-items-center justify-content-center flex-md-column">
            <h2 class="mb-2 mt-2">Editar Administrador</h2>
            <div class="mb-2 w-100 position-relative">
                <label for="id_admin" class="text-white">Matricula:</label>
                <input type="number" class="form-control text-center" name="id_admin" value="<?php echo $txtId; ?>" readonly>
            </div>
            <div class="mb-2 w-100 position-relative">
            ...
            <div>
                <a href="../crud-admin.php" class="btn btn-danger">Cancelar</a>
