    ...
    <div class="container d-flex flex-column">
        <div class="row mb-2">
            <div class="col-md-4 d-flex align-items-center justify-content-center">
                <a href="../docente/perfil.php?id_docente=<?php echo $_GET['id_docente'] ?>" class="card bg-transparent">
            ...
            <div class="col-md-4 d-flex align-items-center justify-content-center">
                <a href="../docente/horarios.php?id_docente=<?php echo $_GET['id_docente'] ?>" class="card bg-transparent">
            ...
            <div class="col-md-4 d-flex align-items-center justify-content-center">
                <a href="../docente/materias.php?id_docente=<?php echo $_GET['id_docente'] ?>" class="card bg-transparent">
                    <img class="card-img-top" src="../assets/icons/file-black.svg" alt="Card image cap">
                    <hr class="mb-0 mt-0">
                    <div class="card-body">
                        <p class="card-text text-center">Materias</p>
                    </div>
                </a>
            </div>
        </div>
