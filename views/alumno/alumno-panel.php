...
<body>
    <div class="row d-flex flex-row justify-content-between h-100 m-0">
                        ...
                        <nav>
                            <ul class="mt-5">
                                <li class="mb-4">
                                    ...
                                    <p onclick="panel_principal(`id_alumno=<?php echo $user->getMatricula(); ?>`)">Panel principal</p>
                                </li>
                                <li class="mb-4">
                                    <img src="../../../escuela/views/assets/icons/user-gray.svg" class="">
                                    <p onclick="ver_perfil(`id_alumno=<?php echo $user->getMatricula(); ?>`)">Perfil</p>
                                </li>
                                <li class="mb-4">
                                    <img src="../../../escuela/views/assets/icons/calendar.svg" class="">
                                    <p onclick="ver_horario(`id_alumno=<?php echo $user->getMatricula(); ?>`)">Horario</p>
                                </li>
                                <li class="mb-4">
                                    <img src="../../../escuela/views/assets/icons/file-gray.svg" class="">
                                    <p onclick="ver_calificaciones(`id_alumno=<?php echo $user->getMatricula(); ?>`)">Calificaciones</p>
                                </li>
        ...
        <div class="cont-panel col-md-10">
            ...
            <div class="panel">
                <iframe src="../../../escuela/views/alumno/panel-principal.php?id_alumno=<?php echo $user->getMatricula(); ?>" id="panel-alumno" frameborder="0"></iframe>
            </div>
        </div>
    ...
    <!-- Boostrap -->
     ...
     <script src="../../../escuela/views/js/vistas-alumno.js"></script>
</body>
</html>