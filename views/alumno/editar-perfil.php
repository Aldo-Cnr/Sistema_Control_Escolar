...
<body class="d-flex align-items-center justify-content-center vh-100">
    <?php
        include('/xampp/htdocs/escuela/controllers/alumnos/editar-perfil-controller.php');
    ?>
    <!-- Modal Editar Alumno-->
    <div class="container d-flex align-items-center justify-content-center">
        <form method="POST" class="d-flex align-items-center justify-content-center flex-md-column">
            ...
            <div>
                <a href="../../views/alumno/perfil.php?id_alumno=<?php echo $_GET['id_alumno']; ?>" class="btn btn-danger">Cancelar</a>
