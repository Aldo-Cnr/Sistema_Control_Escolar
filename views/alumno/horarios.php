        ...
        <table class="table table-primary">
            ...
            <tbody class="table-secondary">
                ...
                <tr class="">
                    ...
                    <td>
                        <a href="../../controllers/alumnos/ver-horarios.php?id_semestre=<?php echo $semestre['id_semestre']; ?>&id_alumno=<?php echo $_GET['id_alumno']; ?>" class="btn btn-outline-success">Ver horario</a>
